...
try {
    ...
    config = {
        ...
        gemini: { apiKey: process.env.GEMINI_API_KEY || 'GEMINI_API_KEY_PLACEHOLDER', model: 'gemini-2.0-flash-exp' },
        shopify: { storeName: process.env.SHOPIFY_STORE_NAME || 'SHOPIFY_STORE_NAME_PLACEHOLDER', accessToken: process.env.SHOPIFY_ACCESS_TOKEN || 'SHOPIFY_ACCESS_TOKEN_PLACEHOLDER' },
        blogSettings: {
